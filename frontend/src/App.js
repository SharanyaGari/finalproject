...
function App() {
  ...
  // const { isAuthenticated, tokenAboutToExpire } = authState
  ...
  useEffect(() => {
    ...
    if (authState.isAuthenticated) {
      refreshAccessTokenTimerId = setTimeout(() => {
        ...
        console.log("timer expired, setting auth state: ", authState)
      }, 10000); // new Date(authState.expiresAt).getTime() - 
    }
  ...
  return (
    <Router>
      ...
      <div
        ...
        >
          <Modal show={authState.tokenAboutToExpire} size='xl' fullscreen='md-down'>
          <Modal.Header>
            <Modal.Title>Login Form</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p>
              Token is about to expire. Continue session??
            </p>
          </Modal.Body>
          <Modal.Footer>
